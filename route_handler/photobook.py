...
from db.data_models import DAOPhotobooks, PhotobookStatus, UserProvidedOccasion
from db.externals import PhotobooksOverviewResponse
...
from lib.utils.web_requests import save_uploads_to_tempdir
from route_handler.base import RouteHandler
from worker.job_processor.types import AssetCompressUploadInputPayload, JobType
    ...
    async def photobook_new(
        ...
        async with self.app.new_db_session() as db_session:
            ...
            async with JobManager(
                self.app.local_redis_factory, JobQueue.LOCAL_MAIN_TASK_QUEUE
            ) as job_manager:
