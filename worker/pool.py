...
from worker.process.base import SHUTDOWN_SIGNAL_MSG, BaseWorkerProcess
from worker.process.local import LocalJobWorkerProcess
from worker.process.remote import RemoteJobWorkerProcess
...
PROCESS_RESTART_PACEOUT_SECS = 8
