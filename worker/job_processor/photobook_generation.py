    ...
    async def process(
        ...
        async with self.db_session_factory.new_session() as db_session:
            ...
            if photobook_refetched.status == PhotobookStatus.UPLOAD_FAILED:
                logging.warning(
                    f"Upload failed for {input_payload.originating_photobook_id}. "
